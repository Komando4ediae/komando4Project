/* para solucionar el issue #19 hemos utilizado la API de meteoblue. Con la API
podemos acceder a datos que guardamos en un objeto datosmeteo como el de abajo.
*/
const datosmeteo={
    "metadata": {
      "name": "",
